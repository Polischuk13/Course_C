...
Console.Write("Enter the number of row 1: ");
int row_1 = int.Parse(Console.ReadLine()!);
Console.Write("Enter the number of column 1: ");
int column_1 = int.Parse(Console.ReadLine()!);

Console.Write("Enter the number of row 2: ");
int row_2 = int.Parse(Console.ReadLine()!);
Console.Write("Enter the number of column 2: ");
